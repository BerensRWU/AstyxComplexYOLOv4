...
def save_checkpoint(checkpoints_dir, saved_fn, model_state_dict, utils_state_dict, epoch):
    ...
    model_save_path = os.path.join(checkpoints_dir, f'Model_{saved_fn}_epoch_{epoch}.pth')
    utils_save_path = os.path.join(checkpoints_dir, f'Utils_{saved_fn}_epoch_{epoch}.pth')
